...
public class StatsCommand extends Command {
    ...
    public boolean onCommand(CommandMessage context, String[] args) {
        context.makeEmbeddedMessage(MessageType.INFO,
            new MessageEmbed.Field(context.i18n("fields.Bot Owner"), "[ClearlyElevated#0001](https://discord.io/underground_server)", true),
            new MessageEmbed.Field(context.i18n("fields.website"), "[Website](https://clearlyelevated.tk)", true),
            ...
            .setTitle(context.i18n("title"), "https://discord.io/underground_server")
